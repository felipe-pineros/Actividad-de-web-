...
export const products: Product[] = [   // 👈 AGREGA "export"
    ...
    },
    {
        ...
        description:
            "Zapatilla ultraligera con tejido respirable y amortiguación reactiva.",
        stock: 8,
    },
    {
        id: 4,
        ...
        description:
            "Estilo retro con acabado en cuero sintético y suela antideslizante.",
        stock: 16,
    },
    {
        id: 5,
        ...
        description:
            "Diseño urbano con soporte lateral reforzado y plantilla ergonómica.",
        stock: 10,
    },
    {
        id: 6,
